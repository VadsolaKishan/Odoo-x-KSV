    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <button className="px-4 py-2 text-xs font-bold bg-transparent border border-slate-350 dark:border-dark-700 text-slate-700 dark:text-dark-300 rounded-lg hover:border-slate-400 dark:hover:border-dark-500 hover:bg-slate-50 dark:hover:bg-dark-800 transition-all select-none">
            May 2025
          </button>
          <button 
            onClick={() => {
            ...
            className="px-4 py-2 text-xs font-bold bg-transparent border border-slate-350 dark:border-dark-700 text-slate-700 dark:text-dark-300 rounded-lg hover:border-slate-400 dark:hover:border-dark-500 hover:bg-slate-50 dark:hover:bg-dark-800 transition-all select-none"
          >
            Export
          </button>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* Total Spend */}
        <div className="border border-slate-250 dark:border-dark-800 rounded-xl p-6 flex flex-col items-center justify-center text-center bg-transparent">
      ...
      <div className="bg-white dark:bg-dark-900 border border-slate-200 dark:border-dark-850 rounded-2xl shadow-premium dark:shadow-dark-premium p-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          
          {/* Left Side: Spend by Category */}
          <div className="lg:col-span-5 space-y-6">
            <h3 className="text-xs font-bold text-slate-550 dark:text-dark-400 uppercase tracking-wider">
              SPEND BY CATEGORY
            </h3>
            ...
            <div className="space-y-5">
              {/* IT Hardware */}
              <div>
                <div className="flex justify-between items-center text-sm font-semibold text-slate-700 dark:text-dark-200">
                  <span>IT Hardware</span>
                  <span>₹4.8L</span>
                </div>
                <div className="w-full bg-slate-100 dark:bg-dark-800 h-2.5 rounded-full mt-1.5 overflow-hidden">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="overflow-hidden border border-slate-150 dark:border-dark-800 rounded-xl">
                <table className="w-full text-xs text-left">
                  <thead className="bg-slate-50 dark:bg-dark-850 text-slate-500 dark:text-dark-400 font-bold border-b border-slate-150 dark:border-dark-800">
                    <tr>
                  ...
                  <tbody className="divide-y divide-slate-150 dark:divide-dark-800 text-slate-700 dark:text-dark-250 font-semibold">
                    <tr className="hover:bg-slate-50/50 dark:hover:bg-dark-850/30">
            ...
            <div className="space-y-3">
              ...
              <div className="border border-slate-150 dark:border-dark-800 rounded-xl p-4">
                <div className="flex items-end justify-between h-32 px-4 pt-4">
                  ...
                  <div className="flex flex-col items-center gap-2 w-8">
                    ...
                    <span className="text-[10px] text-slate-400 dark:text-dark-500 font-bold">Dec</span>
                  </div>
                  {/* Jan */}
                  <div className="flex flex-col items-center gap-2 w-8">
                    <div className="w-5 bg-blue-200 dark:bg-blue-900/40 rounded-t-sm" style={{ height: '50%' }}></div>
                    <span className="text-[10px] text-slate-400 dark:text-dark-500 font-bold">Jan</span>
                  </div>
                  {/* Feb */}
                  <div className="flex flex-col items-center gap-2 w-8">
                    <div className="w-5 bg-blue-200 dark:bg-blue-900/40 rounded-t-sm" style={{ height: '40%' }}></div>
                    <span className="text-[10px] text-slate-400 dark:text-dark-500 font-bold">Feb</span>
                  </div>
                  {/* Mar */}
                  <div className="flex flex-col items-center gap-2 w-8">
                    <div className="w-5 bg-blue-200 dark:bg-blue-900/40 rounded-t-sm" style={{ height: '70%' }}></div>
                    <span className="text-[10px] text-slate-400 dark:text-dark-500 font-bold">Mar</span>
                  </div>
                  {/* Apr */}
                  <div className="flex flex-col items-center gap-2 w-8">
                    <div className="w-5 bg-blue-200 dark:bg-blue-900/40 rounded-t-sm" style={{ height: '60%' }}></div>
                    <span className="text-[10px] text-slate-400 dark:text-dark-500 font-bold">Apr</span>
                  </div>
                  {/* May */}
                  <div className="flex flex-col items-center gap-2 w-8">
