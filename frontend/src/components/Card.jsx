  ...
  return (
    <div 
      ...
      className={`glass-panel p-5 rounded-2xl transition-all duration-300 ${
        onClick ? 'cursor-pointer hover:-translate-y-1 hover:shadow-premium-hover dark:hover:shadow-dark-hover' : ''
      }`}
    >
      <div className="flex items-center justify-between">
        <span className="text-xs font-semibold text-slate-500 dark:text-dark-400 uppercase tracking-wider">{title}</span>
        {Icon && (
      ...
      <div className="mt-4">
        <h3 className="text-2xl sm:text-3xl font-display font-bold text-slate-800 dark:text-dark-100 tracking-tight">
          {value}
        </h3>
